...
CREATE TABLE Movie(
	...
	MovieTitle			VARCHAR(400)	NOT NULL	DEFAULT 'No Movie Title',
...
CREATE TABLE Season(
	...
	SeasonTitle	VARCHAR(400)	NOT NULL	DEFAULT 'No Season Title',
...
CREATE TABLE Episode(
	...
	EpisodeTitle	VARCHAR(400)	NOT NULL	DEFAULT 'No Episode Title',
